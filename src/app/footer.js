      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-4">
        <div className="flex flex-col items-center justify-between md:flex-row">
          <div className="flex items-center space-x-4">
            ...
            <Link href="https://linkedin.com/in/votre-profile" target="_blank" rel="noopener noreferrer">
          ...
          <div className="mt-4 md:mt-0">
            <p className="text-center ">© {new Date().getFullYear()}  Kamil Kazi Tous droits réservés.</p>
          </div>
        </div>
      </div>
    </footer>
